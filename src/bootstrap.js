...
async function bootstrapUnomi() {
  ...
  const schemas = [
    {
      ...
      $id: "https://ecommerce-demo.com/schemas/events/addToCart/1-0-0",
      self: { vendor: "com.ecommerce-demo", name: "addToCart", format: "jsonschema", target: "events", version: "1-0-0" },
    ...
    {
      $schema: "https://json-schema.org/draft/2019-09/schema",
      $id: "https://ecommerce-demo.com/schemas/events/removeFromCart/1-0-0",
      self: { vendor: "com.ecommerce-demo", name: "removeFromCart", format: "jsonschema", target: "events", version: "1-0-0" },
    ...
    {
      $schema: "https://json-schema.org/draft/2019-09/schema",
      $id: "https://ecommerce-demo.com/schemas/events/purchaseComplete/1-0-0",
      self: { vendor: "com.ecommerce-demo", name: "purchaseComplete", format: "jsonschema", target: "events", version: "1-0-0" },
    ...
    {
      $schema: "https://json-schema.org/draft/2019-09/schema",
      $id: "https://ecommerce-demo.com/schemas/events/viewProduct/1-0-0",
      self: { vendor: "com.ecommerce-demo", name: "viewProduct", format: "jsonschema", target: "events", version: "1-0-0" },
  ...
  const rules = [
    {
      metadata: { id: "trackElectronicsInterest", name: "Track Electronics Interest", scope: SCOPE, enabled: true },
      condition: {
        type: "booleanCondition",
        parameterValues: {
          operator: "and", subConditions: [
            { type: "eventTypeCondition",    parameterValues: { eventTypeId: "addToCart" } },
            { type: "eventPropertyCondition", parameterValues: { propertyName: "properties.category", comparisonOperator: "equals", propertyValue: "Electronics" } },
          ]
        },
      },
      actions: [{ type: "setPropertyAction", parameterValues: { setPropertyName: "properties.interestedInElectronics", setPropertyValue: "true", setPropertyStrategy: "alwaysSet" } }],
    },
    {
      metadata: { id: "trackFashionInterest", name: "Track Fashion Interest", scope: SCOPE, enabled: true },
      condition: {
        type: "booleanCondition",
        parameterValues: {
          operator: "and", subConditions: [
            { type: "eventTypeCondition",    parameterValues: { eventTypeId: "addToCart" } },
            { type: "eventPropertyCondition", parameterValues: { propertyName: "properties.category", comparisonOperator: "equals", propertyValue: "Fashion" } },
          ]
        },
      },
      actions: [{ type: "setPropertyAction", parameterValues: { setPropertyName: "properties.interestedInFashion", setPropertyValue: "true", setPropertyStrategy: "alwaysSet" } }],
    },
    {
  ...
  const segments = [
    ...
    {
      metadata: { id: "electronics-enthusiast", name: "Electronics Enthusiast", scope: SCOPE, enabled: true },
      condition: { type: "profilePropertyCondition", parameterValues: { propertyName: "properties.interestedInElectronics", comparisonOperator: "equals", propertyValue: "true" } },
    },
    {
      metadata: { id: "fashion-enthusiast", name: "Fashion Enthusiast", scope: SCOPE, enabled: true },
      condition: { type: "profilePropertyCondition", parameterValues: { propertyName: "properties.interestedInFashion", comparisonOperator: "equals", propertyValue: "true" } },
    },
    {
  ...
  try {
    const r = await unomiRequest("POST", "/cxs/scoring", {
      ...
      elements: [
        ...
        { condition: { type: "profilePropertyCondition", parameterValues: { propertyName: "properties.interestedInElectronics",  comparisonOperator: "equals",      propertyValue: "true"      } }, value: 15 },
